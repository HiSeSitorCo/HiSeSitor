 ...
 * 
 */
public class Estrategia_espiral_simple extends Estrategia {
	public int periodo;
	...
	public Estrategia_espiral_simple(ArrayList<Sensor> sen, ArrayList<Integer> v) {
		super(sen, v);
		nombre = "Espiral simple";
	...
	public void update() {
		...
		while (espiralAux > 0 && cont < MAX) {
			...
			/*
			 * if (first == 1) { itAux-=transitado; if (transitado > 0) { j++; }
			 * }
			 */
			switch (paso) {
			...
			if (first == 1) {
				...
				transito = it;
				/*
				 * transito--; if (it == transitado+1) {
				 * pasoPasado=(pasoPasado+1)%4; transitado = -1; }
				 */
			}
